...
support_vectors = clf.support_vectors_            # выделение опорных векторов
w = lin_clf.coef_[0]                # коэффициенты линейной модели
print(w, support_vectors, sep='\n')
...
plt.scatter(support_vectors[:, 0], support_vectors[:, 1], s=70, edgecolor=None, linewidths=0, marker='s', c='y')
